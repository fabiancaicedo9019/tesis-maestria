...
Establecer\todo{Definir buenas prácticas para...} las estrategias y métodos para incorporar de manera efectiva componentes de Inteligencia Artificial en las soluciones orientadas al sector de seguridad y salud en el trabajo, considerando los requerimientos funcionales del software.
...
\begin{enumerate}
    ...
    \item Desarrollo de un prototipo funcional \todo{yo quitaría esto: mínimo que sirva como demostración del siguiente punto, es decir, }que aplique el marco de trabajo documentado\todo{propuesto}. Este aplicativo será web y modular, diseñado para permitir la integración de un componente de Inteligencia Artificial.
